...
import { startAgentChannelActivityMonitor } from "../../extensions/discord/src/monitor/agent-channel-activity.js";
...
export async function startGatewaySidecars(params: {
  ...
  return { pluginServices, agentChannelActivityMonitor };
}
